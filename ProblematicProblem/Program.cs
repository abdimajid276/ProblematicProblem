...
public class ProblematicProblem
{
        ...
        
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Invalid respone. Please type a valid age.");
            }
            ...
            {
                Console.WriteLine("That is not a valid option. Please type sure/no thanks");
                userResponse = Console.ReadLine().ToLower();
            }
            ...
            while (cont)
            {
                ...
                {
                    Console.WriteLine("That was not a valid oprion. Please type keep/redo");
                    userResponse = Console.ReadLine().ToLower();
                }
